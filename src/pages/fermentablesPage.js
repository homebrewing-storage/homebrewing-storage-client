...
const FermentablesPage = () => {
    ...
    const handleFetch = () => {
      async function fetch() {
        try {
            const response = await axios.get(`http://vps-71bedefd.vps.ovh.net/api/fermentables`, { headers: context.authObj.authHeader() })
    ...
    return (
        <div>
          <Grid container justify="space-between" alignItems="center">
            ...
            <Grid>  
              <Button variant="outlined" type="submit" component={NavLink} to='/fermentable/add'>
                  ADD
              </Button>
            </Grid>
          </Grid>
